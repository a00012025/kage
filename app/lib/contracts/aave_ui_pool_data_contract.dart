...
class AaveUiPoolDataContract extends DeployedContract {
  AaveUiPoolDataContract(ContractAbi abi, EthereumAddress address)
      : super(abi, address);
  static AaveUiPoolDataContract create() {
    return AaveUiPoolDataContract(
      ContractAbi.fromJson(jsonEncode(aaveAbi), 'Aave UiPool Data Provider V3'),
      Constants.aaveUiPoolDataProvider,
    );
  }

  ContractFunction get getReservesData => function('getReservesData');
}
