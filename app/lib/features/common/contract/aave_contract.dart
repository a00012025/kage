...
class AaveContract extends DeployedContract {
  AaveContract(ContractAbi abi, EthereumAddress address) : super(abi, address);
  static AaveContract create() {
    return AaveContract(
      ContractAbi.fromJson(jsonEncode(aaveAbi), 'Aave Pool V3'),
      Constants.aave,
    );
  }
